//Based on Github EOS Boiler Template Simple
...
class Index extends Component {
  ...
  // stop default behaviour
    ...
    const eos = Eos({keyProvider: privateKey, httpEndpoint: 'http://54.79.80.54:8888'});
  ...
  getTable() {
    const eos = Eos({httpEndpoint: 'http://54.79.80.54:8888'});
    eos.getTableRows({
      "json": true,
